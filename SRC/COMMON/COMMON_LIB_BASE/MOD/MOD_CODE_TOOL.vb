...
#Region "VB互換置換用"
    ...
    Public Function IsDate(ByVal oTarget As Object) As Boolean
        ...
        If Not (TypeOf oTarget Is String) Then
            Return False
        End If

        'ここから文字で扱う
        strTEMP = oTarget.ToString
        If DateTime.TryParse(strTEMP, datTEMP) Then
            Return True
        Else
            Return False
        End If
...
#Region "文字列編集関連"
    '特定の文字列を任意の文字列で囲む
    Public Function FUNC_ADD_ENCLOSED( _
    ByVal strBASE As String, ByVal strENCLOSE As String _
    ) As String
        Dim strRET As String
    ...
    Public Function FUNC_ADD_ENCLOSED_SCOT( _
    ...
    Public Function FUNC_ADD_ENCLOSED_REMOVE( _
    ByVal strBASE As String, ByVal strENCLOSE As String, _
    Optional ByVal blnRTRIM_SPACE As Boolean = True _
    ) As String
        Dim strRET As String
        Dim strTEMP As String
    ...
    Public Function FUNC_REPRACE_STRING( _
    ByVal strBASE As String, _
    ByVal strREPRACE_FROM As String, ByVal strREPRACE_TO As String _
    ) As String
        Dim strRET As String
    ...
    Public Function FUNC_LTRIM_CHAR( _
    ByVal strBASE As String, _
    ByVal chrTRIM As Char _
    ) As String
    ...
    '左端特定文字列の削除
    Public Function FUNC_L_REMOVE_STRING( _
    ByVal strBASE As String, _
    ByVal strREMOVE As String _
    ) As String
        Dim strTEMP As String
        Dim strRET As String
    ...
    '右端特定文字列の削除
    Public Function FUNC_R_REMOVE_STRING( _
    ByVal strBASE As String, _
    ByVal strREMOVE As String _
    ) As String
        Dim strTEMP As String
    ...
    '文字の切断(バイト数指定)+不足分の整形(スペース付与)
    '例："あいうえおかきくけこ",10→"あいうえお"
    Public Function FUNC_CUT_STRING_BYTE_AND_APPEND( _
    ByVal strBASE As String, ByVal intBYTE As Integer, Optional ByVal chrAPPEND As Char = " " _
    ) As String
        Dim strAPPEND As String
        Dim strRET As String

        strAPPEND = strBASE & New String(chrAPPEND, intBYTE)
        strRET = FUNC_CUT_STRING_BYTE(strAPPEND, intBYTE)
    ...
    '文字の切断(バイト数指定)
    '例："あいうえおかきくけこ",10→"あいうえお"
    Public Function FUNC_CUT_STRING_BYTE( _
    ByVal strBASE As String, ByVal intBYTE As Integer _
    ) As String
        Dim strRET As String
        Dim strTEMP As String
    ...
    Public Function FUNC_CHECK_SHIFT_JIS( _
    ByVal strBASE As String _
    ) As Boolean
        Dim bytUNI As Byte()
        Dim bytSJIS As Byte()
        ...
        bytSJIS = System.Text.Encoding.Convert( _
        System.Text.Encoding.GetEncoding("unicode"), System.Text.Encoding.GetEncoding("shift_jis"), _
        bytUNI _
    ...
    '文字配列を文字列型へ変換
    Public Function FUNC_CONVERT_CHAR_ROW_TO_STRING( _
    ByVal chrROW() As Char _
    ) As String
        Dim intLOOP_INDEX As Integer
        Dim strRET As String
    ...
    '文字列配列を文字列型へ変換(インデックス=1から)
    Public Function FUNC_CONVERT_STRING_ROW_TO_STRING( _
    ...
    Optional ByVal strSEP As String = "," _
        ...
        strRET = ""
        For intLOOP_INDEX = intSTART To (strROW.Length - 1)
            strRET &= If(intLOOP_INDEX = intSTART, "", strSEP) & strROW(intLOOP_INDEX)
        Next
    ...
    Public Function FUNC_SPLIT_STR( _
    ByVal strBASE As String, ByVal intINDEX As Integer, _
    Optional ByVal chrSPLIT_CHAR As Char = "," _
    ) As String
    ...
    Public Function FUNC_SPLIT_STR_CONV_INT_ROW( _
    ByVal strBASE As String, _
    Optional ByVal chrSPLIT_CHAR As Char = "," _
    ) As Integer()
        Dim strROW() As String
...
#Region "特殊なキャスト"
    ...
    Public Function FUNC_CAST_INT_TO_BOOL( _
    ...
    'BOOL型→INT型
    '例：TRUE→1,FALSE→0
    Public Function FUNC_CAST_BOOL_TO_INT( _
    ...
    Public Function FUNC_CAST_STR_TO_BOOL( _
    ByVal chrVALUE As Char _
    ) As Boolean
    ...
    '例：TRUE→"レ",FALSE→""
    Public Function FUNC_CAST_BOOL_TO_STR_CHECK( _
    ByVal blnVALUE As Boolean _
    ) As String
        Dim strRET As String
    ...
    'BOOL型→STR型(可否文字列表記用)
    '例：TRUE→"○",FALSE→"×"
    Public Function FUNC_CAST_BOOL_TO_STR_PROPRIETY( _
    ByVal blnVALUE As Boolean _
    ) As String
        Dim strRET As String
...
#Region "強制キャスト"
    ...
    Public Function FUNC_VALUE_CONVERT_NUMERIC( _
    ByVal objBASE_VALUE As Object, _
    Optional ByVal dblDEFFAULT_NUM As Double = -1 _
    ) As Double
    ...
    Public Function FUNC_VALUE_CONVERT_DATETIME( _
    ByVal objBASE_VALUE As Object, _
    Optional ByVal dblDEFFAULT_DATETIME As DateTime = cstVB_DATE_MIN _
    ) As DateTime
    ...
    Public Function FUNC_VALUE_CONVERT_STRING( _
     ByVal objBASE_VALUE As Object, _
     Optional ByVal dblDEFFAULT_STRING As String = "" _
     ) As String
        Dim strRET As String
    ...
    Public Function FUNC_VALUE_CONVERT_NUMERIC_INT( _
    ByVal objBASE_VALUE As Object, _
    Optional ByVal intDEFFAULT_NUM As Integer = -1 _
    ) As Integer
        Dim intRET As Integer
        Dim lngTEMP As Long
    ...
    Public Function FUNC_VALUE_CONVERT_NUMERIC_LONG( _
    ByVal objBASE_VALUE As Object, _
    Optional ByVal lngDEFFAULT_NUM As Long = -1 _
    ) As Long
        Dim lngRET As Long
        Dim lngTEMP As Long

        lngTEMP = FUNC_VALUE_CONVERT_NUMERIC(objBASE_VALUE, lngDEFFAULT_NUM)
        If lngTEMP > Long.MaxValue Then
            Return lngDEFFAULT_NUM
        End If
...
#Region "配列関連"
    Public Function FUNC_CHECK_INT_ROW( _
    ByRef intROW() As Integer, ByVal intCHECK_VALUE As Integer, _
    Optional ByVal intCHECK_CNT As Integer = 1 _
    ) As Boolean
        Dim intLOOP_INDEX As Integer
...
#Region "区切文字列関連"
    ...
    Public Function FUNC_SEARCH_INDEX_FROM_STRING_ROW( _
    ByVal strROW() As String, ByVal strSEARCH As String _
    ) As Integer
        Dim intLOOP_INDEX As Integer
        Dim intRET As Integer
    ...
    Public Function FUNC_GET_STRING_FROM_DELIMTED_STR_SEARCH( _
    ByVal strBASE As String, ByVal strDELIMTED As String, ByVal strSEACH As String _
    ) As String
        Dim strRET As String
    ...
    Public Function FUNC_GET_STRING_FROM_DELIMTED_STR( _
    ByVal strBASE As String, ByVal strDELIMTED As String, ByVal intNUMBER As Integer _
    ) As String
...
#Region "切捨・切上"
    ...
    '四捨五入
    Public Function FUNC_MATH_ROUND( _
    ByVal decVALUE As Decimal, _
    Optional ByVal intKETA As Integer = 0 _
    ) As Decimal

        Dim decRATE As Decimal = System.Math.Pow(10, intKETA)
        Dim decTEMP As Decimal
        Dim decRET As Decimal
       
        decTEMP = decVALUE * decRATE
        If decVALUE > 0 Then
            decTEMP = System.Math.Floor(decTEMP + 0.5)
        Else
            decTEMP = System.Math.Ceiling(decTEMP - 0.5)
        End If

        decTEMP = decTEMP / decRATE
        decRET = decTEMP
        Return decRET
    End Function

    '切捨
    Public Function FUNC_MATH_FLOOR( _
    ByVal decVALUE As Decimal, _
    Optional ByVal intKETA As Integer = 0 _
    ) As Decimal
        Dim intKEISU As Integer
        Dim decVALUE_ABS As Decimal
        ...
        decVALUE_ABS = Math.Abs(decVALUE)
        decRATE = 10 ^ intKETA
        decTEMP = decVALUE_ABS * decRATE
        decTEMP = Math.Floor(decTEMP)
        decTEMP = decTEMP / decRATE

        decRET = decTEMP * intKEISU

        Return decRET
    End Function

    '切上
    Public Function FUNC_MATH_CEILING( _
    ByVal decVALUE As Decimal, _
    Optional ByVal intKETA As Integer = 0 _
    ) As Decimal
        Dim intKEISU As Integer
