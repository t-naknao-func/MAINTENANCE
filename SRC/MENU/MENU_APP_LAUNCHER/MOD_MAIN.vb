Module MOD_MAIN
    Private strAPP_TITLE As String
    Friend blnSHOW_SETTING As Boolean
    Friend blnTOTAL_MODE As Boolean
    ...
    Public Sub MAIN(ByVal strCOMMAND_LINE() As String)
        ...
        If Not FUNC_SYSTEM_TOTAL_INITIALIZATION(strCOMMAND_LINE) Then
            Call MessageBox.Show(str_FUNC_SYSTEM_TOTAL_INITIALIZATION_MSG, "", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
        ...
        Do
            If blnSHOW_SETTING Then
                ...
                blnSHOW_SETTING = False
            End If
            strAPP_TITLE = FUNC_GET_APP_SETTINGS("TITLE")
            strTEMP = FUNC_GET_APP_SETTINGS("TOTAL")
            blnTOTAL_MODE = FUNC_CAST_INT_TO_BOOL(CInt(strTEMP))
